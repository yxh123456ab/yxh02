                ...
                <div class="box box-primary">
                  <div class="box-body">
                    <table id="my_order" class="table table-bordered table-striped">
                      ...
                      <c:forEach items="${tborders_all}" var="order">
                      <tr>
                        <td>${order.orderId }</td>
                        ...
                        <c:when test="${order.sta==0}">
                        <span class="label bg-yellow" value="${order.sta}" id="zly_style">待处理</span>
                        </c:when>
                        <c:when test="${order.sta==1}">
                        <span class="label bg-aqua" value="${order.sta}" id="zly_style">处理中</span>
                        </c:when>
                        <c:when test="${order.sta==2}">
                        <span class="label bg-green" value="${order.sta}" id="zly_style">已发货</span>
                        </c:when>
                        
                        <c:when test="${order.sta==3}">
                        <span class="label bg-red" value="${order.sta}" id="zly_style">已交付</span>
                        </c:when>
                        ...
                        <td>${order.placed }</td>
                        <td>￥${order.payment }</td>
                        <td><a  href="Mangement_others?method=show_details&order_id=${order.orderId }" >查看</a>丨
                        <c:choose>
                        <c:when test="${order.sta==3}">处理</c:when>
                        <c:when test="${order.sta!=3}">
                        <a href="Mangement_others?method=show_process&order_id=${order.orderId }" >处理</a></c:when>
                        </c:choose>
