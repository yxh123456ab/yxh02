    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="fm-add" role="form" action="bookAdd?method=addBook" method="post"
...
<script>
    ...
    function check(){
        ...
        //正整数
        if(!/^[0-9]*[1-9][0-9]*$/.test($pages)){
            alert("页数为整数");
            return false;
        }else if(!/^[0-9]*[1-9][0-9]*$/.test($words)){
            alert("字数为整数");
            return false;
        }else if(!/^[0-9]*[1-9][0-9]*$/.test($edition)){
            alert("版本为整数");
            return false;
        }/*else if(!/^(-?\\d+)(\\.\\d+)?$/.test($price)){
            alert("价格为数字类型");
            return false;
        }*/else if($title == ""||$author==""||$price==""||$published==""){
            alert("请将信息填写完整");
            return false;
        }
