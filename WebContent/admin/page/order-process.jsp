        ...
        <div class="col-sm-4 invoice-col my_info">
          ...
          <div class="form-group my_formgroup">
            ...
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios1" value="0" >待处理
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios2" value="1" >处理中
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios3" value="2">已发货
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios4" value="3" disabled>已交付
              </label>
            </div>
            <div class="radio my_radio">
...
var esta=${order.sta};
$("input[type=radio][name='optionsRadios'][value="+esta+"]").attr("checked",'checked');
...
$(".btn-default").on("click",function(){
	...
	var sta= $("input[name='optionsRadios']:checked").val();
	
	
	$.ajax({
        type:"POST",
        url:"Mangement_others?method=cope_sta&sta="+sta+"&order_id="+"${order.orderId}",
