...
<form action="pay-success.html" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        <!-- 支付订单信息-->
        <div class="pay_info">
            <b>支付金额：<i>${zj}元</i></b><input type="hidden" name="payment" value="0.01"/>
            <span>支付订单：${order_id} 收款方：达内商城</span><input type="hidden" name="orderId" />
        </div>
        <!--支付方式-->
        <div id="pay_type">
            <!-- 支付方式头-->
...
<script>
    ...
    $(".okPay").click(function () {
    	...
    	var url = "new_Don_tKnow?method=check_one_payment&order_id="+order_id+"&address_id="+address_id+"&zj="+zj+"&user_id="+user_id;
        //alert(url);
    	window.location.href = url;
